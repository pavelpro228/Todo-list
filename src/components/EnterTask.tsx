...
export const EnterTask = ({ getTasks, tasksArr }: EnterTaskProps, ) => {
    ...
    return (
        <div style={{display: "block"}}>
            <form style={{display: "flex", alignItems: "center"}} onSubmit={addTask}>
            <input 
                value={value} 
            ...
            />
            <Button type='submit' variant="danger" className='py-2 px-4'>Create task</Button>
            </form>
